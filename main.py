...
class ChangePassword(Screen):
    def change(self,uid,ied):
        ...
        if uid==ied:
            url = 'https://igertto-f455s9.firebaseio.com/.json'
            auth_key = 'wUF3LvBPcGwAeeterwerTRRTUSGYWEEEVi4HG' 
...
class HomeND(Screen):
    ...
    url = 'https://bAGHFADS9.firebaseio.com/.json' # You must add .json to the end of the URL
    auth_key = 'PvrFYMAGGTOLGTR5jhfhadhgFs4b8Vi4HG' # Refer to the YouTube video on where to find this.
...
class Login(Screen):
    url = 'https://bhgqhqhqh.ebaseio.com/.json'
    auth_key = 'wgohrhrymhoewrwAFs4b8Vi4HG' # Refer to the YouTube video on where to find this.
